      ...
      >
        <defs>
          <clipPath id="bannerClip">
            <rect x="0" y="0" width="390" height="168" />
          </clipPath>
        </defs>

        <rect width="390" height="168" fill="var(--color-green)" />
        ...
        <g clipPath="url(#bannerClip)">
          ...
          {/* (c) 線稿書背排,底緣 y=168,靠右出血 */}
          <g stroke="#FDFCFA" strokeWidth="1.5" fill="none" strokeLinejoin="round">
            <rect x="236" y="122" width="14" height="46" />
            <rect x="254" y="112" width="12" height="56" /> {/* 印數字這本 */}
            {/* 描黃 NOTES 這本(fill 蓋掉 group 的 none) */}
            <rect x="270" y="118" width="16" height="50" fill="var(--color-highlight)" stroke="#FDFCFA" />
            {/* 斜倚這本:底角仍觸底緣 */}
            <rect x="290" y="120" width="12" height="50" transform="rotate(-10 296 168)" />
            <rect x="312" y="108" width="13" height="60" />
            <rect x="329" y="126" width="15" height="42" />
            <rect x="348" y="114" width="14" height="54" />
            <rect x="368" y="120" width="30" height="48" /> {/* 出血右緣 */}
          </g>
          <text
            fontFamily="Cormorant"
            fontStyle="italic"
