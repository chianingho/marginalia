...
// 這是原本首頁那隻（無黑邊描邊、單純色塊剪影），開場動畫改版一度換成
// marginalia-splash-prototype.html 裡另一隻有黑色輪廓線的新畫法，使用者
// 看過覺得原本這隻比較可愛，改回來——兩邊都用這份，不重刻。
// 座標是原本 BrandBanner 那份 440×218 viewBox 底下量出來的本地座標，呼叫端
// 要換位置/裁切一律外層包 <g transform="..."> 或調整外層 <svg viewBox="...">
// 來做，不要動這裡的路徑數字。
